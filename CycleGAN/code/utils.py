...
def parse_opt():
    ...
    # image datasets
    parser.add_argument("--data_root_A", type=str, default="/home/sh/lab/GAN/paper_review/code/cycle_gan/horse2zebra/trainA")
    parser.add_argument("--data_root_B", type=str, default="/home/sh/lab/GAN/paper_review/code/cycle_gan/horse2zebra/trainB")
    ...
    # wandb & logging
    parser.add_argument("--prj_name", type=str, default="CycleGAN")
    ...
    parser.add_argument("-f", "--fxxk", help="jupyer fxxk", default="1")
